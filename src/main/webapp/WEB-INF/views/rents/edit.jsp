                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="begin" name="begin" value="${rent.debut}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="end" name="end" value="${rent.fin}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
